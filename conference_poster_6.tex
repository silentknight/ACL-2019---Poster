...
\Huge\textbf{Using SPk Languages to Explore the Characteristics of Long Distance Dependencies} \color{Black}\\[2cm] % Subtitle
\huge\fontfamily{put}\textbf{Abhijit Mahalunkar \& Prof. John D. Kelleher}\\[0.5cm]
\huge Applied Intelligence Research Centre\\[0.4cm]
...
\includegraphics[width=0.5\linewidth]{spk_k.png}
\captionof{figure}{\color{Green} Figure caption}
\end{center}\vspace{1cm}

\begin{center}\vspace{1cm}
\includegraphics[width=0.5\linewidth]{spk_len.png}
\captionof{figure}{\color{Green} Figure caption}
\end{center}\vspace{1cm}
...
\toprule
\multirow{2}{*}{Models} & \multicolumn{4}{c}{Test Perplexity in \emph{bpc}} \\ \cline{2-5}
    & SP$2$ & SP$4$ & SP$8$ & SP$16$ \\
\midrule
$1$   & $1.6855$ & $1.8038$ & $1.9611$ & $2.0759$ \\
$2$   & $1.413$ & $1.486$ & $1.658$ & $1.708$ \\
\bottomrule
\end{tabular}
\captionof{table}{Perplexity score of $1$: Transformer-XL and $2$: AWD-LSTM models of SP$2$, SP$4$, SP$8$ and SP$16$ datasets with vocabulary size $V{=}4$}
...
\bottomrule
\end{tabular}
\captionof{table}{Perplexity score of $1$: Transformer-XL and $2$: AWD-LSTM models of SP$2$, SP$4$, SP$6$ and SP$8$ datasets with vocabulary size $V{=}26$}
\label{tab:perplexity_score_v26}
\end{center}
